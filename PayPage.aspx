<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PayPage.aspx.cs" Inherits="CarRental.PayPage" %>
                            ...
                            <div class="vehicle-item">
                                ...
                                <div class="vehicle-info">
                                    ...
                                    <div class="vehicle-details">
                                        <span><i class="fas fa-users"></i> <asp:Label ID="lblSeating" runat="server"></asp:Label> chỗ</span>
                                        <span><i class="fas fa-gas-pump"></i> <asp:Label ID="lblFuelType" runat="server"></asp:Label></span>
                                    </div>
                                    <div class="vehicle-license">
                                        <i class="fas fa-id-card"></i> Biển số: <asp:Label ID="lblLicensePlate" runat="server"></asp:Label>
                                    </div>
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <div class="duration-box">
                                Số ngày thuê: <asp:Label ID="lblDuration" runat="server">0</asp:Label> ngày
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="right-column">
                    <div class="summary-card">
                        ...
                        <div class="summary-body">
                            <div class="row">
                                <span>Giá thuê xe (x<asp:Label ID="lblDays" runat="server">0</asp:Label> ngày)</span>
                                <span><asp:Label ID="lblSubTotal" runat="server">0 VNĐ</asp:Label></span>
                            </div>
                            <div class="row">
                                <span>Phí dịch vụ</span>
                                <span><asp:Label ID="lblServiceFee" runat="server">0 VNĐ</asp:Label></span>
                            </div>
                            <div class="row">
                                <span>Phí bảo hiểm</span>
                                <span><asp:Label ID="lblInsuranceFee" runat="server">0 VNĐ</asp:Label></span>
                            </div>
                            <div class="divider"></div>
                            <div class="row total">
                                <span>Tổng cộng</span>
                                <span class="total-price"><asp:Label ID="lblTotal" runat="server">0 VNĐ</asp:Label></span>
                            </div>
                        </div>
