    ...
    <style>
        * {
        ...
        body {
            ...
            align-items: center;
            min-height: 100vh;
            background: linear-gradient(rgba(31, 41, 55, 0.70)), url('https://images.unsplash.com/photo-1492144534655-ae79c964c9d7?w=1920&q=80') center/cover;
    ...
    <form id="form1" runat="server">
        <div class="container">
            <div class="form-box login">
                ...
                Chưa có tài khoản?<asp:LinkButton ID="lbtnSignUp" runat="server" OnClick="lbtnSignUp_Click">Đăng ký</asp:LinkButton>    
            </div>
        </div>
    </form>
